...
/// @title World Lotto V4 rounds
/// @notice Ledger-only purchases; ordered rounds and UMA-confirmed results.
/// @dev Admin may close/cancel rounds. Only the Oracle adapter may confirm results.
    ...
    IGameModuleV4
{
    ...
    function initialize(address admin_, IUnifiedLedgerV4 ledger_, address treasury_, uint256 ticketPrice_)
        public
        initializer
    {
